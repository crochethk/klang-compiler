...
for test_file in $TEST_FILE_DIR/test_*.c; do
    ...
    java --enable-preview -cp "bin:src/main/java:src/main/gen:src/test/java:code_gen:lib/*:" L1Compiler $SRC_FILE_COMPILE_DIR $SRC_FILES_DIR/${src_file_name_no_ext}.L1 > /dev/null
